...
app.post("/data/spirit", async (q, s) => s.send({ d: miscHandler.band_delay }));
...
app.get("/admin/band_scheduler", MiscAuth.getAuthed(__dirname + "/src/manage/admin/band_scheduler.html", "band_scheduler"));

app.get("/admin/update", MiscAuth.getAuthed(__dirname + "/src/manage/admin/update.html", "update"));

app.post("/admin/setter/band_schedule", miscHandler.setBandDelay);
